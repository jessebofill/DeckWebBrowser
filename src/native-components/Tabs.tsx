...
import { fakeRenderComponent, findInReactTree, sleep } from 'decky-frontend-lib';
import { findModule } from 'decky-frontend-lib';
import { FooterLegendProps } from 'decky-frontend-lib';
...
// try {
//     console.log("JLOG> looking for old tabs")
...
export const Tabs =
    oldTabs ||
    (((props: TabsProps) => {
    // console.log("JLOG> Tabs props: ", props)
        ...
        useEffect(() => {
            ...
            (async () => {
                ...
                console.debug('[DFL:Tabs]: Found!', t);
                setTC(t);
            })();
        }, []);
        // console.log('tc', tc);
